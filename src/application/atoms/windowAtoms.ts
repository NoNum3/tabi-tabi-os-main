...
import { isPlayingAtom as ambienceIsPlayingAtom } from "@/apps/ambiencePlayer/atoms/ambiencePlayerAtom";
// Import the safe pause function from AmbiencePlayer
// NOTE: This creates a slight coupling, but necessary for direct control
import { safeAudioPause } from "@/apps/ambiencePlayer/ambiencePlayer";
